$(function () {
    ...
    if (dtUserTable.length) {
      dtUserTable.DataTable({
        ...
        serverSide: true,
        ajax: {
          url: `${window.location.protocol}//${window.location.host}/business-types/getall`,
          method: 'post',
    ...
    $(document).on('click', '.edit-cms-modal', function() {
        ...
        $('#add-new-acc-types').attr('action', '/business-types/update');
        $('#title').val(title);
    ...
    $(document).on('click', '.add-new', function() {
        ...
        $('#add-new-acc-types').attr('action', '/business-types/store');
        $('#title').val('');
        $('#description').val('');
        $('#id').val('');
    ...
    $(document).on('click', '.statusUpdate', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${window.location.protocol}//${window.location.host}/business-types/status-change/${elemID}`;
            }
        });
    });
    ...
    $(document).on('click', '.deleteType', function() {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = `${location.protocol}//${window.location.host}/business-types/delete/${elemID}`;
            }
        });
    });
});
