$(function () {
    ...
    if (dtUserTable.length) {
      dtUserTable.on( 'processing.dt', function () {
        ...
        serverSide: true,
        ajax: {
          url: `${window.location.protocol}//${window.location.host}/suppliers/getall`,
          method: 'post',
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              var $row_output =
                ...
                '<a href="' + window.location.protocol + '//' + window.location.host + '/suppliers/view/' + full["_id"] + '" class="user_name text-truncate text-body"><span class="fw-bolder">' +
                $name +
                '</span></a>' +
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              let actionBtn = (
                ...
                '<a href="' + window.location.protocol + '//' + window.location.host + '/suppliers/view/' + full["_id"] + '" class="dropdown-item">' +
    ...
    $(document).on('click', '.userStatusUpdate', function () {
      ...
      swal.fire({
          ...
          if (result.value) {
              window.location.href = `${window.location.protocol}//${window.location.host}/suppliers/status-change/${elemID}?status=${result.value}`;
          }
      });
    });
    ...
    $(document).on('click', '.deleteUser', function() {
      ...
      swal.fire({
          ...
          if (result.value) {
              window.location.href = `${location.protocol}//${window.location.host}/suppliers/delete/${elemID}`;
          }
      });
    });
    ...
    $(document).on('click', '.verify-force', function() {
      ...
      swal.fire({
          ...
          if (result.value) {
              window.location.href = `${location.protocol}//${window.location.host}/suppliers/verify-forcefully/${elemID}?type=${type}`;
          }
      });
    });
